...
//		// Position the eye behind the origin.
		...
		if (mProgramHandle != 0) {
			...
			GLES20.glLinkProgram(mProgramHandle);
			 mTextureDataHandle0 = loadTexture(mActivityContext, R.drawable.white1);
			 mTextureDataHandle1 = loadTexture(mActivityContext, R.drawable.white2);
			 mTextureDataHandle2 = loadTexture(mActivityContext, R.drawable.white3);
			 mTextureDataHandle3 = loadTexture(mActivityContext, R.drawable.white4);
			 mTextureDataHandle4 = loadTexture(mActivityContext, R.drawable.white5);
			 mTextureDataHandle5 = loadTexture(mActivityContext, R.drawable.white6);
